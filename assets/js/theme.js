...
(function ($) {
	...
	jQuery(document).ready(function () {
		...
		$('.wpc_menu .logo').append(mobileLogoContent);
		$('.wpc_menu .wpc_navmenu').append(mobileMenuContent);
        $( '.wpc_menu .wpc_navmenu ul.main_menu li.menu-item-has-children').append( $( "<span class='submenu_opener'><i class='bi bi-chevron-right'></i></span>" ) );

        // Sub-Menu Open On-Click
        $('.wpc_menu ul.main_menu li.menu-item-has-children .submenu_opener').on("click", function(e){
        ...
        $('.wpc_menu_toggle').on('click', function(e) {
            $('body').addClass('wpc_menu_active');
            e.stopPropagation();
            e.preventDefault();
        });
        $('.wpc_menu_close').on('click', function(e) {
            $('body').removeClass('wpc_menu_active');
            e.stopPropagation();
            e.preventDefault();
        });
        $('.wpc_menu_overlay').on('click', function(e) {
            $('body').removeClass('wpc_menu_active');
            e.stopPropagation();
            e.preventDefault();
        });
